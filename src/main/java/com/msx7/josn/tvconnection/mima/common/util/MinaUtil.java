package com.msx7.josn.tvconnection.mima.common.util;
...
public class MinaUtil {
    ...
    public static synchronized void messageRecevie(Message message,
        ...
        MessageHandler handler = MessageHandlerLib.getInstance().getHandler(String.valueOf(head.getActionCode()));
        Log.d("MSG","ActionCode-----  "+head.getActionCode()+" handler "+(handler==null));
        if (handler != null)
